export const entityColumnSets = {
    ...
    salesHeader: [
        ...
        {field: 'customer.address', headerName:'Direccion', width: 240, valueGetter: (params) => params.row?.customer?.address},
        {field: 'order_date', headerName:'Fecha', width: 120},
        {field: 'order_status', headerName:'Estado', width: 100},
        {field: 'total_amount', headerName:'Monto Total', width: 100},
        {field: 'paid_amount', headerName:'Pagado', width: 100},
    ],
    priceListDetail:[
    ...
    invoiceHeader:[
        ...
        {field: 'invoice_type', headerName: 'Tipo', width: 40},
        {field: 'customer.customer_id', headerName:'Id Cliente', width: 120,   valueGetter: (params) => params.row?.customer?.customer_id},
        {field: 'customer.name', headerName:'Nombre Cliente', width: 180, valueGetter: (params) => params.row?.customer?.name},
        {field: 'customer.address', headerName:'Direccion', width: 240, valueGetter: (params) => params.row?.customer?.address},
        {field: 'invoice_date', headerName: 'Fecha Factura', width: 120},
        {field: 'total_gross_amount', headerName: 'Total Bruto', width: 120},
        {field: 'total_tax_amount', headerName: 'Total Impuestos', width: 120},
        {field: 'total_net_amount', headerName: 'Total Neto', width: 120},
    ]
}
